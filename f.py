...
# ─── ТОЛЬКО САМЫЕ ПОПУЛЯРНЫЕ ДОМЕНЫ ──────────────────────────
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    welcome_text = (
        ...
        "2. Я сгенерирую данные аккаунта\n"
        "3. Реши капчу вручную в браузере\n"
        "4. Вставь токен в бота\n"
        "5. Получи прокси!\n\n"
...
async def get_proxies_start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    instruction = (
        ...
        "3. Найди reCAPTCHA и реши её (нажми «Я не робот»)\n"
        "4. Открой инструменты разработчика (F12)\n"
        "5. Перейди на вкладку Console\n"
        "6. Вставь команду и нажми Enter:\n"
        "`document.querySelector('[name=g-recaptcha-response]').value`\n"
        "7. Скопируй полученную длинную строку (токен)\n"
        "8. *Вставь токен в сообщение этому боту*\n\n"
